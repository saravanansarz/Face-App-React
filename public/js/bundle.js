...
var AddCharacterActions = function () {
  function AddCharacterActions() {
    ...
    this.generateActions('addCharacterSuccess', 'addCharacterFail', 'updateName', 'updatePassword', 'updateGender', 'invalidName', 'invalidGender');
  }

  _createClass(AddCharacterActions, [{
    key: 'addCharacter',
    value: function addCharacter(name, password, gender) {
      var _this = this;
...
var HomeActions = function () {
  function HomeActions() {
    ...
    this.generateActions('getTwoCharactersSuccess', 'getTwoCharactersFail');
  }

  _createClass(HomeActions, [{
    key: 'deleteCharacter',
    value: function deleteCharacter(characterId) {
      $.ajax({
        type: 'POST',
  ...
  _createClass(AddCharacter, [{
    ...
    value: function handleSubmit(event) {
      ...
      if (name && password && gender) {
        _AddCharacterActions2.default.addCharacter(name, password, gender);
      }
    }
  }, {
    key: 'render',
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'password', className: 'form-control', ref: 'nameTextField', value: this.state.password,
                      onChange: _AddCharacterActions2.default.updatePassword, autoFocus: true })
                  ),
                  _react2.default.createElement(
                    'div',
...
var Home = function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    key: 'handleDelete',
    value: function handleDelete(characterId, event) {
      _HomeActions2.default.deleteCharacter(characterId);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var characterNodes = this.state.characters.map(function (character, index) {
        return _react2.default.createElement(
          'div',
          { key: character.characterId, className: 'col-xs-6 col-sm-6 col-md-5 col-md-offset-1' },
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('img', { src: '../img/delete.png', onClick: _this2.handleDelete.bind(_this2, character.characterId), alt: 'Smiley face', height: '42', width: '42' })
            )
          )
        );
      });
